...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      // Facebook
      { property: 'author', content: 'PARIS IAS' },
      { property: 'og:site_name', content: 'https://www.positive-future.org' },
      { property: 'og:locale', content: 'en_US' }, // TODO: update
      { property: 'og:type', content: 'website' }, // TODO: update
      // Twitter
      { property: 'twitter:site', content: 'https://www.positive-future.org' }, // TODO: update
      {
        property: 'twitter:domain',
        content: 'https://www.positive-future.org',
      },
      { property: 'twitter:creator', content: 'PARIS IAS' },
      { property: 'twitter:card', content: 'summary' }, // TODO: update
      { property: 'twitter:image:src', content: '/images/logo.png' }, // TODO: update
      { property: 'og:url', content: 'https://www.positive-future.org' },
      ...
      { name: 'twitter:site', content: 'https://www.positive-future.org' },
